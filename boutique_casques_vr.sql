...
--
-- Hôte : db
-- Généré le : sam. 13 déc. 2025 à 09:49
...
INSERT INTO `utilisateurs` (`id_utilisateur`, `nom_utilisateur`, `courriel`, `mot_de_passe`, `solde`) VALUES
(1, 'Abdoulaye', 'abdoulaye@example.com', 'abc@123', 5047.26),
(2, 'William', 'william@example.com', 'abc@123', 5161.09),
(3, 'Sedrick', 'sedrick@example.com', 'abc@123', 8150.43),
(4, 'Alexandre', 'alexandre@example.com', 'abc@123', 6770.74);
...
--
ALTER TABLE `articles_panier`
  MODIFY `id_article_panier` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
